...
const pageImages = {
  '/admin':              'https://images.unsplash.com/photo-1562774053-701939374585?w=1920&auto=format&fit=crop&q=80',
  '/admin/formations':   'https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=1920&auto=format&fit=crop&q=80',
  '/admin/conseillers':  'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=1920&auto=format&fit=crop&q=80',
  '/admin/etudiants':    'https://images.unsplash.com/photo-1607237138185-eedd9c632b0b?w=1920&auto=format&fit=crop&q=80',
}
...
export default function AdminLayout() {
    ...
    <>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-4 py-2 mb-2">
          ...
          <div><p className="text-sm font-medium text-white">{user?.name}</p><p className="text-xs text-white/60">Admin</p></div>
        </div>
  ...
  return (
    <div className="flex min-h-screen relative">
      ...
      <div className="fixed inset-0 bg-indigo-950/80 z-0" />
